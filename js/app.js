 ...
 */
    ...
    (() => {
        ...
        function initMainNewsSliders() {
            if (document.querySelector(".main-news__content")) new Swiper(".main-news__content", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                autoHeight: true,
        ...
        function initGraduatesSliders() {
            if (document.querySelector(".graduates__slider")) new Swiper(".graduates__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                autoHeight: true,
...
***************************************************************************** */
        ...
        function handleResize() {
            ...
            const photos = document.querySelectorAll(".info__photo");
            for (let i = 0; i < photos.length; i++) {
                const photo = photos[i];
                if (screenWidth < 375) photo.style.height = `${screenWidth * .5}px`; else if (screenWidth < 768) photo.style.height = `${screenWidth * .53}px`; else if (screenWidth < 992) photo.style.height = `${screenWidth * .375}px`; else if (screenWidth < 1280) photo.style.height = "380px"; else photo.style.height = "321px";
            }
        }
